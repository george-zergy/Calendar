...
- (NSAttributedString*)calendarYearView:(MGCYearCalendarView *)view headerTextForMonthAtDate:(NSDate*)date
{
    ...
    NSMutableAttributedString* str = [[NSMutableAttributedString alloc]initWithString:month attributes:@{ NSFontAttributeName:font, NSForegroundColorAttributeName:[[[UIApplication sharedApplication] delegate] window].tintColor, NSParagraphStyleAttributeName: para }];
    return str;
}
